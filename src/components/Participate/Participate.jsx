...
const Participate = () => {
  return (
    <section className="h-screen bg-white w-screen flex flex-col gap-5 justify-center items-center">
 <h1 className="text-3xl font-bold">Why Participate in <span className="text-[#0FA958]"> AI Challenges?</span></h1>
    <div className="cardSection flex flex-wrap items-center justify-center gap-5 mt-5">
    <div className="w-[33.875rem] bg-gray-100 h-[17.25rem] p-[1.25rem] flex flex-col gap-[0.5rem] justify-end items-start rounded-lg">
